...
export async function researcher(
  ...
  const result = await experimental_streamText({
    ...
    maxTokens: 2500,
    system: `if you know the answer provide it immediately in the same language it was asked in. As a professional search expert, you possess the ability to search for any information on the web. 
